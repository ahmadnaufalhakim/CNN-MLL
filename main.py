...
conv2d_img = cl.ConvolutionalLayer(image, (300, 300), 3, 3, 5, 2)
...
# conv2d_arr = cl.ConvolutionalLayer(array, (300, 300), 3, 3, 5, 2)
...
# conv2d = cl.ConvolutionalLayer(dummy_array, (2, 2), 5, 2, 1, 1)
